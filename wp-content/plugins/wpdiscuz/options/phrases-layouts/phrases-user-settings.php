    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_content_and_settings" id="wc_content_and_settings"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_user_settings_activity"><?php esc_html_e("Activity", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text"
                                   value="<?php echo esc_attr($this->phrases["wc_user_settings_activity"]); ?>"
                                   name="wc_user_settings_activity" id="wc_user_settings_activity"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_subscriptions" id="wc_user_settings_subscriptions"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_user_settings_follows"><?php esc_html_e("Follows", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text"
                                   value="<?php echo esc_attr($this->phrases["wc_user_settings_follows"]); ?>"
                                   name="wc_user_settings_follows" id="wc_user_settings_follows"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_response_to" id="wc_user_settings_response_to"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_email_me_delete_links"
                                   id="wc_user_settings_email_me_delete_links"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_request_deleting_comments"
                                   id="wc_user_settings_request_deleting_comments"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_cancel_subscriptions"
                                   id="wc_user_settings_cancel_subscriptions"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_clear_cookie" id="wc_user_settings_clear_cookie"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_delete_links" id="wc_user_settings_delete_links"/></td>
        </tr>
        <tr valign="top">
            <th scope="row">
            ...
            <td colspan="3"><input type="text"
                                   value="<?php echo esc_attr($this->phrases["wc_user_settings_delete_all_comments"]); ?>"
                                   name="wc_user_settings_delete_all_comments"
                                   id="wc_user_settings_delete_all_comments"/></td>
        </tr>
        <tr valign="top">
            <th scope="row">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   value="<?php echo esc_attr($this->phrases["wc_user_settings_delete_all_subscriptions"]); ?>"
                                   name="wc_user_settings_delete_all_subscriptions"
                                   id="wc_user_settings_delete_all_subscriptions"/></td>
        </tr>
        <tr valign="top">
            <th scope="row">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   value="<?php echo esc_attr($this->phrases["wc_user_settings_delete_all_follows"]); ?>"
                                   name="wc_user_settings_delete_all_follows" id="wc_user_settings_delete_all_follows"/>
            </td>
        </tr>
        <tr valign="top">
            <th scope="row">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_subscribed_to_replies"
                                   id="wc_user_settings_subscribed_to_replies"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_subscribed_to_replies_own"
                                   id="wc_user_settings_subscribed_to_replies_own"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_subscribed_to_all_comments"
                                   id="wc_user_settings_subscribed_to_all_comments"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_check_email" id="wc_user_settings_check_email"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_user_settings_email_error" id="wc_user_settings_email_error"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_cancel_this_subscription" id="wc_cancel_this_subscription"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_confirm_comment_delete" id="wc_confirm_comment_delete"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_confirm_cancel_subscription" id="wc_confirm_cancel_subscription"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_confirm_cancel_follow" id="wc_confirm_cancel_follow"/></td>
        </tr>
        </tbody>
    </table>
</div>